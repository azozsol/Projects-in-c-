...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_BoardCell_t, stringdata0) + ofs), len 
...
const QMetaObject BoardCell::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_BoardCell.offsetsAndSize,
